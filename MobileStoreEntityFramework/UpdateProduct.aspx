<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateProduct.aspx.cs" Inherits="MobileStoreEntityFramework.UpdateProduct" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="Container">
        <div class="row">
            <h1 id="rsltrec" runat="server">
                    

            </h1>
            <div class="col-md-12">
                <div class="form-group">
                    <h1>Enter Product Details for Updation</h1>
                <table border="5px">
                  <tr>
                        <td>
                        ...
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtID" ErrorMessage="Fill ID"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <asp:Button ID="btnSend" runat="server" Text="Update" class="btn btn-primary" OnClick="btnSend_Click"/></td>
                        <td></td>
                    </tr>
